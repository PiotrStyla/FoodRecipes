...
public class HorisontalDotedProgress extends View {
    //actual dot radius
    ...
    public HorisontalDotedProgress(Context context) {
        super(context);
    }

    public HorisontalDotedProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorisontalDotedProgress(Context context, AttributeSet attrs, int defStyleAttr) {
